...
| [routing-and-pages.md](./routing-and-pages.md) | URL 設計（2026-08-24 再設計後：検索複数形/詳細単数形型別/モーダル/詳細の4責務）。SEO-2 noindex。 | 2026-08-30 |
| [env-import.md](./env-import.md) | Import 基盤（EnvironmentSource / Detector chain / Analyzer + SHA-1 Worker / Analysis / ZIP fallback）+ **Phase 12-A の Sync 基盤（ManagedFileRecord / `computeSyncPlan`）**。 MojoLauncher (mojo_instance.json) 検出含む。 | 2026-08-29 |
...
| [testing.md](./testing.md) | vitest+msw+fake-indexeddb・browserApi stub 基盤・per-module カバレッジ・E2E（CI のみ）。 | 2026-08-30 |
