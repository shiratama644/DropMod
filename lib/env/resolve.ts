...
import { buildTargetPath, CATEGORY_DIR_KEY, type SyncPlanEntry } from '@/features/sync/diff';
import type { ResolveContent, ResolvedContent } from '@/features/sync/executor';
import { itemsOfCategory } from '@/features/sync/managed';
