...
| ORG-5 | coverage threshold 未達の回復 (store.ts branches 76.47%<80% / hooks 59.15%<60%) | 未着手 | 0% | ORG-2 | `pnpm test:coverage` exit 0 (threshold 全 pass)。対象: `src/features/profiles/store/store.ts` (branches 80%)・`src/hooks/**/*.ts` (branches 60%) | 計画 §11 / `.agent/logs/2026-08-31_codebase-org-2.md` |
