...
| 2-2 | 構造化データ (JSON-LD / schema.org) | 🥇 高 | 高 (最大の伸び代) | 中 | **SEO-1 実施** |
| 2-3 | 動的 OGP 画像 (`next/og` 1200×630) | 🥇 高 | 高 (CTR) | 中 | **SEO-1 実施** |
| 2-4 | パンくず表示 + `BreadcrumbList` | 🥈 中 | 中 | 小 | **SEO-1 実施** (2-2 と同時) |
| 2-5 | sitemap 拡充 (全 4 型 + lastmod) | 🥈 中 | 中 | 小 | **SEO-1 実施** |
| 2-6〜 | (低優先: 見出し構造・内部リンク強化等) | 🥉 低 | 低 | 小 | **SEO-1 実施** (discover h1 / カテゴリリンク) |
